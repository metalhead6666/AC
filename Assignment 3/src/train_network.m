function handles = train_network(handles)
    ...
    if(strcmp(handles.networkName, 'Radial Basis Function'))
		...
		handles.network = newrb(handles.trainingInput, handles.trainingOutput, handles.goal, 1.0, handles.hiddenLayers, 1);

    elseif(strcmp(handles.networkName, 'Layer Recurrent'))
		%Define some of the network's specifications
		layersDelays = 1:2;
		layersSize = repmat(handles.hiddenLayers, 1, handles.numberLayers - 1);
